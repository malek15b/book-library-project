    ...
    return (
        <>
            <div className="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
                <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm p-5 bg-white shadow-2xl">
                    ...
                    <div className="inline-flex items-center justify-center w-full mb-5">
                        ...
                        <span
                            className="absolute px-3 font-medium text-gray-600 -translate-x-1/2 bg-white left-1/2">oder</span>
                    </div>
                    <div className="flex items-center justify-center w-full">
                        <button onClick={props.login}
                                className="btn-primary w-full">Mit Github fortsetzen
                        </button>
                    </div>
                </div>
            </div>
